...
public class BookEmptyBackUI extends BookUI {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8201390158802424639L;
	private FontMetrics fm;
	private Image bufferImg;

	@Override
	public Dimension getPreferredSize(BookView bookView) {
		return new Dimension(20, 110);
	}
	...
	private void drawBackbuffer(BookView bookView) {
		bufferImg = new BufferedImage(20, 100, BufferedImage.TYPE_INT_ARGB);//bookView.createImage(20, 110);
		...
		imgG.drawImage(emptyBack, x, sy, BookShelfConstraints.getBackWidth(), BookShelfConstraints.getHeight(), null);
