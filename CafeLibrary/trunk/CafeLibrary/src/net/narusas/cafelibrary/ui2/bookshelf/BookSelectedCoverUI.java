...
public class BookSelectedCoverUI extends BookUI {
	...
	private void drawBackbuffer(final BookView bookView) {
		...
		imgG.drawImage(coverDropShadow, x
				- BookShelfConstraints.getDropGapWidth(), 5,
				BookShelfConstraints.getDropWidth(), BookShelfConstraints
						.getDropHeight(), null);

		imgG.drawImage(selectionBorder, 0, 0, BookShelfConstraints
				.getDropWidth(), BookShelfConstraints.getDropHeight(), null);

		imgG.drawImage(img, x, BookShelfConstraints.getDropGapHeight(),
				BookShelfConstraints.getWidth(), BookShelfConstraints
						.getHeight(), new ImageObserver() {
		...
		imgG.drawImage(coverMaterialShadow, x, BookShelfConstraints
				.getDropGapHeight(), BookShelfConstraints.getWidth(),
