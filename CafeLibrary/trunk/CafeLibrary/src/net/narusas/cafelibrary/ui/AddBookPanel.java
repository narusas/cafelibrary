	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				this.add(titleSearchTextField, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
			...
			}
			{
				...
				this.add(writeBookButton, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
						GridBagConstraints.NONE, new Insets(0, 0, 0, 10), 0, 0));
				writeBookButton.setText("Enter");
			}
			{
				jTextArea1 = new JTextArea();
				this.add(jTextArea1, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
